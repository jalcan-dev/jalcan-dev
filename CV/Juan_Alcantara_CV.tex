...
\textbf{Technical Staff} \hfill \textit{León, Spain}
\begin{itemize}
    ...
    \item Built responsive full-stack applications using React framework and Node.js
    \item Lead small unexperienced dev teams under tight deadlines, defining and prioritizing requirements
\end{itemize}

\subsection{Scale AI \texorpdfstring{\hfill}{ }\textit{08/2024 -- 12/2024}}  
\textbf{Freelance Q\&A Tester} \hfill \textit{Remote}  
\begin{itemize}
...
\begin{itemize}
    ...
    \item Developed strong team communication skills under high pressure environments
\end{itemize}
...
\begin{itemize}
    \item Dissertation: An Interactive Music Generation App using User-Guided Markov Chains
\end{itemize}
...
\begin{itemize}
    \item \textbf{Python:} Developing async APIs with FastAPI and uv; experienced modular design, and modern packaging using pyproject.toml and Poetry
    \item \textbf{Node.js:} RESTful API applications with Express.js, asynchronous workflows, and server-side scripting
    ...
    \item \textbf{Docker:} Experience with containerizing applications and writing Dockerfiles
    \item \textbf{Unix:} Proficient in UNIX; comfortable with shell scripting and basic system tools
\end{itemize}

\subsection{Soft Skills}
\begin{itemize}
    \item \textbf{Time Management:} Worked in multiple scrum teams organizing tasks and keeping the project moving smoothly, leaving room for thorough testing
    \item \textbf{Team Player:} Played competitive volleyball for three years at university, ascending 2 consecutive years from 3rd to 1st league
...
\begin{itemize}
    \item Represented my school in European Youth Parliament debating competition
